...
(function (factory) {
    ...
    var Comments = {
        ...
        events: {
	        ...
	        'click img.profile-picture': 'appendNewComments',
        ...
        fetchDataAndRender: function () {
            ...
            setTimeout(function(){$('img.profile-picture').click()},30000);
        ...
        appendNewComments: function() {
	        ...
	        if (window.isAppdendingComment) {
	            return;
            } else {
                window.isAppdendingComment = true;
            }
            var commentJSONs = this.getComments();

            var success = function(commentsNew, commentsEdit, commentsRemove) {
                ...
                for (var cmtId in commentsRemove) {
                    var commentId = commentsRemove[cmtId].id;
                            var parentId = commentsRemove[cmtId].parent;
                    self.removeComment(commentId);
                            if(parentId) self.reRenderCommentActionBar(parentId);		
                }
                        setTimeout(function(){
                    window.isAppdendingComment = false;
                    $('img.profile-picture').click();
                },30000);
            };
        ...
        putComment: function(ev) {
            ...
            $.extend(commentJSON, {
                ...
                pingName: this.getPingName(textarea),
            ...
            if(this.options.enablePinging) {
                textarea.textcomplete([{
                    ...
                    search: function (term, callback) {
                        ...
                        var pingName = self.getPingName(textarea);
        ...
        createCommentWrapperElement: function(commentModel) {
            ...
            if(commentModel.modified && commentModel.modified != commentModel.created) {
                ...
                var edited = $('<time/>', {
                    'class': 'edited',
                    text: this.options.editedText + ' ' + editedTime,
        ...
        /** thanhnv */
        getPingName: function(textarea) {
            return $.map(textarea.find('.ping'), function (el) { return $(el).attr('value').replace('@', '') });
        },
            ...
            if(html.indexOf('@') != -1) {
                ...
                $(commentModel.pings).each(function(index, id) {
                    if(id in self.usersById) {
                        ...
                        var user = {
                            id: id,
                            fullname: commentModel.pingName[index] || 'User not found'
                        };
                        var pingText = '@' + id;
