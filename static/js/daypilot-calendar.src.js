        ...
        this._createDaysViewColumns = function() {
            ...
            */
            ...
            for (var i = 0; i < days; i++) {
                ...
                /** THANHNV CHANGE HEADER */
                column.InnerHTML = '<span class="m-days-name">' +column.Name + '</span>' +
                    '<div class="m-days-number">' +
                    column.Start.toString('dd', resolved.locale()) +
                    '</div>';
...
/*                            var div = document.createElement("div");
                            ...
                            if (this.settingCssCustome) {
                                this.settingCssCustome(inner, {start: c.start, end: c.end})
                            }
