...
import { menuFilters } from '@/router/profile'

Vue.use(Vuex)

// const debug = process.env.NODE_ENV !== 'production'
export const storeProfile = new Vuex.Store({
  state: {
  ...
  mutations: {
    ...
    updatePersonalInformation: function (state, payload) { state.personalInformation = payload }
  },
  actions: {
    ...
    loadContacts ({ commit }) {
      let vm = this
      console.log('>>>>>>...state.keySearch', vm.state.keySearch)
