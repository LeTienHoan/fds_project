<template>
  ...
  <div class="activity--manager--component layout wrap calendar-list-wrapper">
    <jx-mobilink-toolbar :extension="true">
      <template slot="toolbar_title">
        <div style="align-items: center;display: flex;">
          <v-btn icon><v-icon>search</v-icon></v-btn> Theo dõi kết luận
        </div>
      </template>
      <template slot="forfilter" style="margin-left: auto">
        <v-layout wrap class="navTable label_class">
          <v-flex xs4 style="margin-left: auto">
            <v-layout>
              <custome-date-time
                    ...
                    >
                      <template slot="items" slot-scope="props">
                        ...
                        <tr v-bind:class="{'active': props.index%2==1}">
                          ...
                          <td class="py-2 text-xs-center">
                            <v-btn icon class="ma-0" @click.stop="removeActivity(props.item,props.index)" v-if="props.item.permission=='owner' || props.item.permission=='leader'" title="Xóa">
...
/*  .activity--manager--component #list-content .expansion-panel{
  ...
  .activity--manager--component .column {
    float: none !important;
  }
  .activity--manager--component tr {
    height: auto !important;
  }
  .activity--manager--component th, .activity--manager--component td {
