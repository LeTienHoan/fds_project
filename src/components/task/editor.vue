...
<script>
  ...
  export default {
    ...
    destroyed () {
      ...
      // delete this.useCustomImageHandler
      // delete this.quill
      // delete this.toolbar
      // delete this.editor
      // delete this.initializeVue2Editor
      // delete this.setQuillElement
      // delete this.setEditorElement
      // delete this.checkForInitialContent
      // delete this.checkForCustomImageHandler
      // delete this.setupCustomImageHandler
      // delete this.handleUpdatedEditor
      // delete this.customImageHandler
      // delete this.emitImageInfo
    },
    ...
    methods: {
      ...
      checkForCustomImageHandler () {
        return this.useCustomImageHandler === true ? this.setupCustomImageHandler() : ''
      },
